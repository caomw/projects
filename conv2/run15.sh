...
# ((a=p-100)); ((b=q-100));
# ((c=p+100)); ((d=q+100));
((a=2*2000/sub)); ((b=2*1600/sub)); ((c=2*2400/sub)); ((d=2*2100/sub));
#((a=-100)); ((b=-100)); ((c=100)); ((d=100));
#src="--corr-search $a $b $c $d"
#src="--corr-search 153 118 353 318"
src="--corr-search $a $b $c $d"
opt="$win_opt $src --corr-max-levels $levels -t dg -s stereo.default --threads 30 --alignment-method none --subpixel-mode $subpix --disable-fill-holes"
if [ $sub -ne 1 ]; then
...
opts="$opt $img1_sub $img2_sub $cam1_sub $cam2_sub $dir/res $dem" # good!
