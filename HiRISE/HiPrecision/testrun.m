%function testrun(imageid, flat1, flat2, flat3)
...
% $$$    flat3   = 'PSP_002158_2035_IR11-RED5.flat.tab';
   ...
   [Sample,Line,ET,AverageError]=createPVLforHiJACK(imagelocation, imageid, lineinterval, flat1, from1, flat2, from2, flat3, from3);
