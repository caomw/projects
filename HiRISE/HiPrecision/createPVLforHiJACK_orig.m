function [Sample,Line,ET,AverageError]=createPVLforHiJACK_orig(imagelocation, imageid, lineinterval, flat1, from1, flat2, from2, flat3, from3)
...
[Sample,Line,ET,AverageError, linerate, TDI]=resolveJitter4HiJACK_orig([imagelocation,flat1], from1, [imagelocation,flat2], from2, [imagelocation,flat3], from3, lineinterval);
data=[Sample,Line,ET];
...
fid=fopen([imagelocation,imageid,'_jitter_orig.txt'], 'wt');
disp(sprintf('--------- Writing %s', [imagelocation,imageid,'_jitter_orig.txt']));
