function testrun_orig(imageid, flat1, flat2, flat3)
...
[Sample,Line,ET,AverageError]=createPVLforHiJACK_orig(imagelocation, imageid, lineinterval, flat1, from1, flat2, from2, flat3, from3);
