...
dir=local2
opts="M0100115.cub E0201461.cub $dir/res --corr-seed-mode 2 --disparity-estimation-dem ref-DEM.tif --disparity-estimation-dem-error 5 --subpixel-mode 1 --stereo-file stereo.default  --left-image-crop-win 0 1024 672 4864 --use-local-homography --alignment-method none"
